...
query_branches = """
        SELECT 
            ...
            CASE WHEN PROPIETARIO_TORRE LIKE '%TELEFONICA%' OR PROPIETARIO_TORRE IS NULL THEN 'technical' ELSE 'external' END type, SUBSTR(COD_MUNICIPIO, 2) AS cod_mun, 0 AS is_j10 
